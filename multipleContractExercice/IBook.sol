...
interface IBook {
    ...
    function addBook(string memory title, string memory author, string memory description, uint price, bool available, uint bookType, uint weight, string memory edition, uint fileSize, string memory fileFormat) external;
